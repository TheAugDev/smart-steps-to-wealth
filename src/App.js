...
<p>2. <strong>Deploy Your sheet as Web App:</strong> Inside your copied sheet, click the "Extensions" tab: <code className="bg-blue-100 text-blue-800 px-1 rounded">Click App Script</code> &rarr; <code className="bg-blue-100 text-blue-800 px-1 rounded">New window will open, click "Deploy" button, select "New Deployment"</code>. Leave the default settings as is but make sure "Web app" is executed as (ME) and "Who has access" is set to (Anyone), then click "Deploy" button. The first time you click this, you will need to authorize the script.</p> 
<p>3. <strong>Paste Your Link Above:</strong> Copy the "Web app URL" link provided in the dialog box and paste it into the input field above.</p>
</div>
</div>
 );
