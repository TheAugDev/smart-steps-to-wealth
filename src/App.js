    ...
    return (
        <div className="bg-slate-50 min-h-screen font-sans text-gray-800">
            ...
            <div className="container mx-auto p-4 sm:p-6 lg:p-8">
                ...
                {showInstructions && !isDataLoaded && (
                  <div className="mb-8 p-6 bg-blue-50 border-l-4 border-blue-400 rounded-lg text-gray-800">
                    <h2 className="text-xl font-bold mb-2">How to Get Your Smart Steps Web App Link</h2>
                    <ol className="list-decimal ml-6 space-y-2">
                      <li>
                        <b>Open your Google Sheet</b> (the template you want to use).
                      </li>
                      <li>
                        Go to <b>Extensions &gt; Apps Script</b> in the Google Sheets menu.
                      </li>
                      <li>
                        In the Apps Script editor, click the blue <b>Deploy</b> button (top right) and select <b>New deployment</b>.
                      </li>
                      <li>
                        Click the gear icon next to <b>"Select type"</b> and choose <b>Web app</b>.
                      </li>
                      <li>
                        Under <b>"Who has access"</b>, select <b>Anyone</b>.
                      </li>
                      <li>
                        Click <b>Deploy</b>. You'll need to authorize the script the first time.
                      </li>
                      <li>
                        Copy the <b>Web app URL</b> provided after deployment. <br/> <span className="text-xs text-gray-600">(It will look like <code>https://script.google.com/macros/s/.../exec</code>)</span>
                      </li>
                      <li>
                        Paste that link into the <b>Smart Steps Link</b> field above.
                      </li>
                    </ol>
                    <p className="mt-4 text-sm text-gray-700">If you need a sample Apps Script or help connecting your sheet, let us know!</p>
                  </div>
                )}
